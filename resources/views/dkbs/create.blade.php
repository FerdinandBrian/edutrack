...
@section('title','Tambah DKBS')

@section('content')
<div class="bg-white rounded-xl shadow p-6 max-w-2xl">
    <h2 class="text-lg font-semibold">Tambah DKBS</h2>
    ...
    <form action="/dkbs" method="POST" class="mt-4 space-y-4">
        @csrf
        <div>
        ...
        <div>
            ...
            <input name="semester" class="w-full border rounded px-3 py-2">
        </div>

        <div>
            <label class="block text-sm text-slate-700 mb-1">Status</label>
            <input name="status" class="w-full border rounded px-3 py-2" placeholder="Terdaftar / Drop">
        </div>
